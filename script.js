const timeDisplay = document.getElementById('time-display');
 ...
 const pauseSound = new Audio('stop.mp3');
 const resumeSound = new Audio('resume.mp3');
 const resetSound = new Audio('Reset.mp3');
 const ambianceSound = new Audio('ambiance.mp3');
 ...
 function start() {
     if (!isRunning && !isRewinding) {
         ...
         ambianceSound.play().catch(e => console.error("Error playing ambiance sound:", e));
 ...
 window.onload = () => {
     ...
     // Remove the fade-in class to trigger the animation
